...
#' # Differential analysis of functional marker expression, choose type as DE, n=2 will perform Mann-Whitney test and n>=3 will perform pairwise wilcoxon test
...
statTest<-function(sce,abuntable=NULL,type='DA',group,posthoc=T, method='pairwise.wilcox.test'){
  ...
  }else if(type == 'DS'){ #differential functional marker expression test among study conditions
    if(is.null(cluster_ids(sce))){
