...
BinaryClust2 is a systematic toolkit which enables data examination and downstream in-depth analysis of cell populations. Basically, it can be divided into two sessions:
...
```{r}
# The example data sit in test_data/test_files, users can download to local machine and test it. Origical fcs files are from Trussart et.al
